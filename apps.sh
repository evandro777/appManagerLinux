...
apps[jpegli, script]="./apps/jpegli.sh"
apps[jpegli, category]="Development"
...
apps[game_optimizations, script]="./apps/game-optimizations.sh"
apps[game_optimizations, category]="Games"
...
apps[heroic, script]="./apps/heroic-flatpak-official.sh"
apps[heroic, category]="Games"
